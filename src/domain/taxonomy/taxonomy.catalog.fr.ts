...
export const HOBBIES: TaxonomyOption<HobbyKey>[] = [
  ...
  { key: 'meditation', label: 'Méditation', group: 'SPORT, NATURE & AVENTURE' },
  { key: 'football', label: 'Football', group: 'SPORT, NATURE & AVENTURE' },
  { key: 'rugby', label: 'Rugby', group: 'SPORT, NATURE & AVENTURE' },
  { key: 'baseball', label: 'Baseball', group: 'SPORT, NATURE & AVENTURE' },
  ...
  { key: 'video_games', label: 'Jeux vidéo', group: 'JEUX' },
  { key: 'poker', label: 'Poker', group: 'JEUX' },
  { key: 'tarot', label: 'Tarot', group: 'JEUX' },
  { key: 'bridge', label: 'Bridge', group: 'JEUX' },
