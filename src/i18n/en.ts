...
export const EN_STRINGS: Record<string, string> = {
  ...
  adminInternalLead: "Admin-only area — you’ll add content here step by step.",
  adminInternalPlaceholder: "No internal blocks yet — tell us what to show here.",
  ...
  profileFormPhotoVisualIntro:
    "Upload a photo from your computer or phone (JPEG, PNG, WebP — max 5 MB). You can also paste a public image URL. Without a photo, an initials avatar is shown.",
  profileFormPhotoVisualIntroShort: "Add a photo so members recognize you in the directory.",
  profileFormPhotoNoHostingNote:
    "LinkedIn photo links often don't work — use local upload or a public URL (Advanced section).",
  profileFormPhotoCredibilityNote:
    "Your LinkedIn link remains a credibility signal. The photo is optional.",
  profileFormPhotoUploadLabel: "Upload a photo",
  profileFormPhotoUploadHint: "JPEG, PNG, WebP or GIF — 5 MB max. The image is stored on the platform.",
  profileFormPhotoUploadButton: "Choose an image",
  profileFormPhotoUploading: "Uploading…",
  profileFormPhotoUploadSuccess: "Photo uploaded — click Save to publish it.",
  profileFormPhotoUploadErrorInvalid: "Unsupported format. Use JPEG, PNG, WebP or GIF.",
  profileFormPhotoUploadErrorSize: "Image too large (5 MB maximum).",
  profileFormPhotoUploadErrorAuth: "Sign in to upload a photo.",
  profileFormPhotoUploadErrorGeneric: "Upload failed. Try again or use a public URL.",
  profileFormPhotoOrUrlDivider: "Or public URL",
  profileFormPhotoPublicUrlLabel: "Direct public photo URL (optional)",
  profileFormPhotoUploadTapAvatar: "Or tap the avatar to choose an image.",
  profileFormPhotoAdvancedToggle: "Advanced — public URL",
  profileFormPhotoAdvancedHint: "Paste a publicly hosted image URL (avoid LinkedIn links).",
