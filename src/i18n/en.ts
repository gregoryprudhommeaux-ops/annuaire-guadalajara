...
export const EN_STRINGS: Record<string, string> = {
  ...
  profileFormPhotoNoHostingNote:
    "LinkedIn photo links often don't work outside LinkedIn — prefer local upload below.",
  ...
  profileFormPhotoUploadSuccess: "Photo uploaded — remember to save your profile.",
