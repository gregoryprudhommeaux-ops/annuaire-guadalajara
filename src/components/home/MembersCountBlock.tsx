...
export default function MembersCountBlock({
  ...
  if (memberCount < threshold) {
    return (
      <div className="rounded-[10px] border border-blue-100 bg-blue-50/90 p-3.5 sm:p-4">
        <div className="flex gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-sm font-semibold text-gray-800">{t('launchTitle')}</p>
            <p className="mt-1 text-[13px] leading-snug text-gray-500">{t('launchSubtitle')}</p>
            <button
              type="button"
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-sm text-gray-700 shadow-sm">
